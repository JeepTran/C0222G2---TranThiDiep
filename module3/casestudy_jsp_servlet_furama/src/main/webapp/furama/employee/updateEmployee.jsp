...
<head>
    ...
    <title>Furama - Update Employee</title>
        ...
        <div class="container-fluid mt-3 w-50">
            <form method="post">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select name="positionId" id="inputEmail8" class="form-select" aria-label="Default select example">
                            <c:forEach items="${positionList}" var="temp">
                                <c:choose>
                                    <c:when test="${temp.positionId == employee.positionId}">
                                        <option value="${temp.positionId}"
                                                selected>${temp.positionName}</option>
                                    </c:when>
                                    <c:otherwise>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select name="educationDegreeId" id="inputEmail9" class="form-select" aria-label="Default select example">
                            <c:forEach items="${educationDegreeList}" var="temp">
                                <c:choose>
                                    <c:when test="${temp.educationDegreeId == employee.educationDegreeId}">
                                        <option value="${temp.educationDegreeId}"
                                                selected>${temp.educationDegreeName}</option>
                                    </c:when>
                                    <c:otherwise>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select  name="divisionId" id="inputEmail10" class="form-select" aria-label="Default select example">
                            <c:forEach items="${divisionList}" var="temp">
                                <c:choose>
                                    <c:when test="${temp.divisionId == employee.divisionId}">
                                        <option value="${temp.divisionId}"
                                                selected>${temp.divisionName}</option>
                                    </c:when>
                                    <c:otherwise>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select  name="username" id="inputEmail11" class="form-select" aria-label="Default select example">
                            <c:forEach items="${userList}" var="temp">
                                <c:choose>
                                    <c:when test="${temp.username == employee.username}">
                                        <option value="${temp.username}"
                                                selected>${temp.username}</option>
                                    </c:when>
                                    <c:otherwise>
