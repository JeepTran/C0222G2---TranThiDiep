        ...
        <form action="/furama?action=create" method="post">
            <fieldset>
                ...
                <table>
                    ...
                    <tr>
                        <td><label>Customer Birthday: </label></td>
                        <td><input type="date" name="customerBirthday"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><label>Customer ID Card: </label></td>
                    ...
                    <tr>
                        ...
                        <td><a href="/furama"><button>Cancel</button></a></td>
                    </tr>
                </table>
            </fieldset>
        </form>
